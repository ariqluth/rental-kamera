...
<div class="content-wrapper">
    ...
    <!-- Main content -->
    <form method="post" action="{{ route('pengembalian.store') }}" id="myForm" enctype="multipart/form-data">
      @csrf
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                <label for="inputName">id_pengambilan</label>
                <input type="number" id="id_ambil" class="form-control" name="id_ambil" value="" >
              </div>
              <div class="form-group">
                <label for="inputDescription">id_pembayaran</label>
                <input type="number" id="id_bayar" class="form-control" rows="4" name="id_bayar" value="" ></input>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="inputClientCompany"> tanggal_Pengembalian</label>
                <input type="date" id="tgl_Pengembalian" name="tgl_Pengembalian" class="form-control">
              </div>
             
              <div class="form-group">
                <label for="inputDescription">Kamera</label>
                <input type="text" id="disewa_kamera" class="form-control" rows="4" name="disewa_kamera" value=""></input>
              </div>
              {{-- <div class="form-group" >
